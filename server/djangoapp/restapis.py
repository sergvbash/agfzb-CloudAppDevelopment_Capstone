...
def get_dealers_by_st(url, **kwargs):
    results = []
    print(kwargs['st']+'!!!')
    # Call get_request with a URL parameter
        ...
        #     # Create a CarDealer object with values in `doc` object
            ...
            if review['purchase'] == True:
                reviews_obj = DealerReview(dealership=review["dealership"], name=review["name"], purchase=review["purchase"],
                                   id=review["id"], review=review["review"], purchase_date=review["purchase_date"],
                                    car_make=review["car_make"], car_model=review["car_model"], car_year=review["car_year"], sentiment=sentiment)
            else:
                reviews_obj = DealerReview(dealership=review["dealership"], name=review["name"],
...
def analyze_review_sentiments(text):
    url = "https://api.us-south.natural-language-understanding.watson.cloud.ibm.com/instances/74b6ad26-211d-4dd3-9a5e-05fa653ca822"
    api_key = "I8oZu-5sUy9i9R6ZpG0m5kZs7Y0UnoWky7TkZ3lIZ6eN"
